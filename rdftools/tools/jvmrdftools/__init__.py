...
#
# ----------------------------------------------------------------------------------------------------------------------
def run_lubm_generator(num_universities, index, generator_seed, ontology, output_path):
...
def run_nxvoid_generator(source, dataset_id, output_path):
...
def run_rdf2rdf_converter(source, destination):
    run_tool("com.rdftools.Rdf2RdfConverter", source, destination)